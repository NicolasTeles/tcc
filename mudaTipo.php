            ...
            <form action="mudaTipo.php?idFunc=<?php echo $idFunc; ?>" method="post">
                <div class="input-block">
                    ...
                    <div style="margin-left: 25%; margin-right: 25%;">
                        <input type="radio" name="tipoFunc" id="tipoAdm" value="ADMIN" <?php if ($exibir["tipoFuncionario"] == "ADMIN") {echo "checked";}?>>
                        <label for="tipoFunc" onclick="marcaTipo('tipoAdm')">Admin</label>
                        <input type="radio" name="tipoFunc" id="tipoComum" value="COMUM" <?php if ($exibir["tipoFuncionario"] == "COMUM") {echo "checked";} ?>>
