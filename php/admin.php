...
<body>
    ...
    if (isset($_SESSION["nomeFunc"])) {
        ...
        <header><img src="../img/logo3.png" class="logoimg">
            <ul class="headerUL">
                <li class="headerLI nomeSession">
                    <?php echo $_SESSION["nomeFunc"]; ?>
                </li>
                <li class="headerLI"><button class="menu-btn"><i class="fa-solid fa-user-gear carrinho fa-3x"></i> </button>
                </li>
            </ul>
            <nav class="navFunc">
                <h1 class="tituloUsuario">
                    <?php echo $_SESSION["nomeFunc"]; ?>
                </h1>
                <a href="editarFuncionario.php?idFunc=<?php echo $_SESSION["idFunc"]; ?>" class="linkUsuario">Editar
                    conta</a>
